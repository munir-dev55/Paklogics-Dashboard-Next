    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path d="M3 7a2 2 0 0 1 2-2h5l2 2h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z M8 12h8M8 16h5" />
          </svg>
        ),
      ...
      },
      {
        icon: (
          <svg
            ...
            strokeLinejoin="round"
          >
            <path d="M6 3h9l4 4v14H5V3h1ZM14 3v5h5M9 12h6M9 16h6" />
          </svg>
        ),
      ...
      //     >
      //       <path
      //         d="M12 2C10.34 2 9 3.34 9 5V6.28C6.61 7.16 5 9.41 5 12V17L3 19V20H21V19L19 17V12C19 9.41 17.39 7.16 15 6.28V5C15 3.34 13.66 2 12 2ZM12 22C13.1 22 14 21.1 14 20H10C10 21.1 10.9 22 12 22Z"
      //         fill="currentColor"
      //       />
      //     </svg>
      //   ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r border-sidebar-divider bg-sidebar text-sidebar-muted lg:static lg:translate-x-0 ${
          sidebarOpen
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="w-full shrink-0 border-t border-sidebar-divider"
        />

        <div className="no-scrollbar flex flex-col overflow-y-auto py-4 duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
        ...
        <div className="mt-auto shrink-0 border-t border-sidebar-divider p-4">
          <button
            type="button"
            onClick={() => setLogoutOpen(true)}
            className="flex w-full items-center gap-3 rounded-lg px-3.5 py-3 font-medium text-sidebar-muted transition-colors hover:bg-sidebar-hover hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
          >
            <svg
              aria-hidden="true"
              width="24"
